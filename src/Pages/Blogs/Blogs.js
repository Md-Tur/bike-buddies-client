    ...
    return (
        <div>
            <div className='mb-2 mt-2'>
                <p>
                    <span className='text-rose-900'>How will you improve the performance of a React Application?</span>
                    <br />
            ...
            <div>
                <p>
                    <span className='text-rose-900'>What are the different ways to manage a state in a React application?</span>
                    <br />
            ...
            <div className='mb-2 mt-2'>
                <p>
                    <span className='text-rose-900'>Why should we not update the state directly?</span>
                    <br />
            ...
            <div>
                <p>
                    <span className='text-rose-900'>What is a unit test? Why should write unit tests?</span>
                    <br />
            ...
            <div className='mb-2 mt-2'>
                <p>
                    <span className='text-rose-900'>How does prototypical inheritance work?</span>
                    <br />
